...
from .executor import execute, ActionExecutionError
        ...
        for step_index in range(1, max_steps + 1):
            ...
            try:
                ...
                step_logger.log_step(
                    step_index, observation, "decide_error", {}, "", page.url, error=str(exc)
                )
                raise AgentBlocked(f"LLM decide step failed: {exc}") from exc
